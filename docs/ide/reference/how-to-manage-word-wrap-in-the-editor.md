...
Word wap in Visual Studio behaves differently to other editors. If you are familiar with word wap in Notepad++, Sublime Text or Visual Studio Code, you may experience the following issues:
